...
# Created by write_sdc on Wed Sep 22 11:45:48 2021
...
create_clock [get_ports CLK]  -period 0.833  -waveform {0 0.4165}
set_max_delay 0.833  -from [list [get_ports CLK] [get_ports RST] [get_ports IRAM_READY] [get_ports \
